...
public class NativeAuthenticationProvider implements AuthenticationProvider<NativePacketPayload> {
     ...
     * at any moment during the connection life-time via a Change Functions.User request.
     * 
    ...
    private void proceedHandshakeWithPluggableAuthentication(final NativePacketPayload challenge) {
        ...
        // Servers not affected by Bug#70865 expect the Change Functions.User Request containing a correct answer to seed sent by the server during the initial handshake,
